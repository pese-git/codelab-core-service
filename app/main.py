...
app.include_router(projects.router, prefix="/api/v1/core")
app.include_router(project_agents.router, prefix="/api/v1/core")
app.include_router(project_chat.router, prefix="/api/v1/core")
app.include_router(project_plans.router, prefix="/api/v1/core")
app.include_router(approvals.router, prefix="/api/v1/core")
app.include_router(project_tools.router, prefix="/api/v1/core")
app.include_router(analytics.router, prefix="/api/v1/core")
app.include_router(streaming.project_router, prefix="/api/v1/core")
app.include_router(monitoring.router, prefix="/api/v1/core")
app.include_router(llm_providers.private_router, prefix="/api/v1/core")
app.include_router(llm_providers.public_router, prefix="/api/v1/core")
