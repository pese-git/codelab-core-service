...
@router.get(
    ...
    deprecated=True,
    summary="Subscribe to streaming events for a chat session (DEPRECATED)",
    description="""
    ⚠️ **DEPRECATED** - Use GET `/my/projects/{project_id}/chat/{session_id}/events/` instead.
...
@router.get(
    "/stats/",
    deprecated=True,
    summary="Get streaming connection statistics (DEPRECATED)",
    description="""
    ⚠️ **DEPRECATED** - This endpoint is still available for backward compatibility.
