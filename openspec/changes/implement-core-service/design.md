...
- **uv** - современный менеджер пакетов и виртуальных окружений
  - Быстрая установка зависимостей (10-100x быстрее pip)
  - Управление виртуальными окружениями
  - Lockfile для воспроизводимых сборок
  
- **ruff** - высокопроизводительный линтер и форматтер кода
  - Замена flake8, black, isort в одном инструменте
...
- **pytest-asyncio** - плагин для асинхронных тестов
  - Поддержка async/await в тестах
  - Критично для тестирования FastAPI endpoints
  - Управление event loop в тестах
